...
export default function SignUpPhoto() {
  ...
  const onSubmit = async () => {
    ...
    if (result.error === 1) {
      ...
      toast.success('Pendaftaran berhasil bro');
                ...
                <div className="mb-20">
                  <div className="image-upload text-center">
                    <label htmlFor="avatar">
                      {imagePreview ? <img src={imagePreview} className="img-upload" width="60" height="60" alt="upload" /> : <Image src="/icon/upload.svg" width="60" height="60" />}
