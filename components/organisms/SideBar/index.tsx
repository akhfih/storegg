    ...
    <section className="sidebar">
      <div className="content pt-50 pb-30 ps-30">
        ...
        <div className="menus">
          ...
          <MenuItem title="Transaction" icon="ic-menu-transaction" active={activeMenu === 'transaction'} href="/member/transaction" />
          ...
          {/* <div className="item mb-30">
            ...
            <p className="item-title m-0">
              <a href="member/transaction" className="text-lg text-decoration-none">Transactions</a>
            </p>
          </div>
          <div className="item mb-30">
            <svg
